...
classdef Particle2DMonitorReader < handle
    %% CST Interface specific functions.
    methods(Access = ?CST.Project)
        % Only CST.Project can create a CST.Particle2DMonitorReader object.
        function obj = Particle2DMonitorReader(project, hProject)
            obj.project = project;
            obj.hParticle2DMonitorReader = hProject.invoke('Particle2DMonitorReader');
        end
    end
    ...
    methods
        ...
        function Reset(obj)
            ...
            obj.hParticle2DMonitorReader.invoke('Reset');
        end
        function SelectDataSource(obj, tree_path)
            ...
            obj.hParticle2DMonitorReader.invoke('SelectDataSource', tree_path);
        end
        function long = GetNFrames(obj)
            % Returns the number of trajectories available.
            long = obj.hParticle2DMonitorReader.invoke('GetNFrames');
        end
        function [tmin, tmax, tstep] = GetFrameInfo(obj, number)
            ...
            functionString = [...
                ...
                'Particle2DMonitorReader.GetFrameInfo(', num2str(number, '%.15g'), ', tmin, tmax, tstep)', newline, ...
            ];
        ...
        function SelectFrame(obj, number)
            ...
            obj.hParticle2DMonitorReader.invoke('SelectFrame', number);
        end
        function long = GetNSamples(obj)
            % Returns the number of samples available in the current frame.
            % Please do not call this method directly. Use the specialized object methods below instead.
            long = obj.hParticle2DMonitorReader.invoke('GetNSamples');
        end
        ...
        function String = GetSourceName(obj, id)
            ...
            String = obj.hParticle2DMonitorReader.invoke('GetSourceName', id);
        end
        function StringArray = GetQuantityNames(obj)
            ...
            StringArray = obj.hParticle2DMonitorReader.invoke('GetQuantityNames');
        end
        function long = GetNComponents(obj, quantity)
            ...
            long = obj.hParticle2DMonitorReader.invoke('GetNComponents', quantity);
        end
        function SingleArray = GetQuantityValues(obj, quantity, component)
            ...
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetQuantityValues', quantity, component);
        end
        function Single = GetQuantityWithReduction(obj, quantity, component, reduction)
            ...
            %                             <function>
            Single = obj.hParticle2DMonitorReader.invoke('GetQuantityWithReduction', quantity, component, reduction);
        end
        function GetGlobalQuantityNames(obj)
            ...
            obj.hParticle2DMonitorReader.invoke('GetGlobalQuantityNames');
        end
        function Single = GetGlobalQuantity(obj, quantity, component)
            ...
            %                     <function>
            Single = obj.hParticle2DMonitorReader.invoke('GetGlobalQuantity', quantity, component);
        end
        ...
        function SingleArray = GetPositionsX(obj)
            ...
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetPositionsX');
        end
        function SingleArray = GetPositionsY(obj)
            % Retrieve the x-, y-, and z-component of all particle positions.
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetPositionsY');
        end
        function SingleArray = GetPositionsZ(obj)
            % Retrieve the x-, y-, and z-component of all particle positions.
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetPositionsZ');
        end
        function SingleArray = GetMomentaX(obj)
            % Retrieve the x-, y-, and z-component of all particle momenta.
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetMomentaX');
        end
        function SingleArray = GetMomentaY(obj)
            % Retrieve the x-, y-, and z-component of all particle momenta.
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetMomentaY');
        end
        function SingleArray = GetMomentaZ(obj)
            % Retrieve the x-, y-, and z-component of all particle momenta.
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetMomentaZ');
        end
        function SingleArray = GetMacroCharges(obj)
            % Retrieve the macro charges of all particles.
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetMacroCharges');
        end
        function SingleArray = GetParticleIDs(obj)
            % Retrieve the unique IDs of all particles (not available for all monitor types).
            SingleArray = obj.hParticle2DMonitorReader.invoke('GetParticleIDs');
        end
        ...
        function StringArray = GetMonitorNames(obj)
            ...
            StringArray = obj.hParticle2DMonitorReader.invoke('GetMonitorNames');
        end
        function SelectMonitor(obj, name)
            ...
            obj.hParticle2DMonitorReader.invoke('SelectMonitor', name);
        end
        function long = GetNPlanes(obj)
            % Returns the number of monitor planes available.
            long = obj.hParticle2DMonitorReader.invoke('GetNPlanes');
        end
        function SelectPlane(obj, number)
            ...
            obj.hParticle2DMonitorReader.invoke('SelectPlane', number);
        end
        function [xNorm, yNorm, zNorm] = GetNormal(obj)
            ...
            functionString = [...
                ...
                'Particle2DMonitorReader.GetNormal(xNorm, yNorm, zNorm)', newline, ...
            ];
        ...
        function [xNorm, yNorm, zNorm] = GetLocalU(obj)
            ...
            functionString = [...
                'Dim xNorm As Double, yNorm As Double, zNorm As Double', newline, ...
                'Particle2DMonitorReader.GetLocalU(xNorm, yNorm, zNorm)', newline, ...
            ];
            returnvalues = {'xNorm', 'yNorm', 'zNorm'};
            [xNorm, yNorm, zNorm] = obj.project.RunVBACode(functionString, returnvalues);
            % Numerical returns.
        ...
        function [xNorm, yNorm, zNorm] = GetLocalV(obj)
            ...
            functionString = [...
                'Dim xNorm As Double, yNorm As Double, zNorm As Double', newline, ...
                'Particle2DMonitorReader.GetLocalV(xNorm, yNorm, zNorm)', newline, ...
            ];
            returnvalues = {'xNorm', 'yNorm', 'zNorm'};
            [xNorm, yNorm, zNorm] = obj.project.RunVBACode(functionString, returnvalues);
            % Numerical returns.
        ...
        function double = GetPlaneDistance(obj)
            ...
            double = obj.hParticle2DMonitorReader.invoke('GetPlaneDistance');
        end
