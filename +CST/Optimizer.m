...
classdef Optimizer < handle
    ...
    methods
        function SetSimulationType(obj, simType)
            ...
            % E-Static Solver                   - Selects the electrostatics  solver.
            % M-Static Solver                   - Selects the magnetostatics solver.
            % Stationary Current Solver         - Selects the stationary current solver.
            % LF Frequency Domain Solver        - Selects the low frequency solver.
            % LF Time Domain Solver             - Selects the lf-time domain solver.
            % Thermal Steady State Solver       - Selects the thermal steady state solver.
            % Thermal Transient Solver          - Selects the thermal transient solver.
            % Structural Mechanics Solver       - Selects the stuctural mechanics solver.
            % PIC Solver                        - Selects the PIC solver.
            % Particle Tracking Solver          - Selects the tracking solver.
            % Wakefield Solver                  - Selects the wakefield solver.
            % Template Based Post-Processing    - Selects the template based post-processing.
        ...
        function SetFiniteDiff(obj, int, string)
            % int: '0'
            % string: 'Trust_Region'
            obj.AddToHistory(['.SetFiniteDiff "', num2str(int, '%.15g'), '", '...
                                             '"', num2str(string, '%.15g'), '"']);
        end
    end
