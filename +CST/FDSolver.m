...
classdef FDSolver < handle
    ...
    methods
        ...
        function StoreSolutionCoefficients(obj, flag)
            ...
            obj.storesolutioncoefficients = flag;
        end
        function CreateLegacy1DSignals(obj, flag)
            ...
            obj.createlegacy1dsignals = flag;
        end
        ...
        function FrequencySamples(obj, nFSamples)
            ...
            obj.frequencysamples = nFSamples;
        end
        ...
        function AddSampleInterval(obj, min, max, samples, key, adaptation)
            ...
            obj.addsampleinterval.min = min;
            obj.addsampleinterval.max = max;
            obj.addsampleinterval.samples = samples;
            obj.addsampleinterval.key = key;
            obj.addsampleinterval.adaptation = adaptation;
        end
        function AddInactiveSampleInterval(obj, min, max, samples, key, adaptation)
            ...
            obj.AddToHistory(['.AddInactiveSampleInterval "', num2str(min, '%.15g'), '", '...
                                                         ...
                                                         '"', num2str(key, '%.15g'), '", '...
                                                         '"', num2str(adaptation, '%.15g'), '"']);
            obj.addinactivesampleinterval.min = min;
            obj.addinactivesampleinterval.max = max;
            obj.addinactivesampleinterval.samples = samples;
            obj.addinactivesampleinterval.key = key;
            obj.addinactivesampleinterval.adaptation = adaptation;
        end
        ...
        function SetPortMeshMatches3DMeshTet(obj, flag)
            ...
            obj.setportmeshmatches3dmeshtet = flag;
        end
        function SetAllowROMPortModeSolver(obj, flag)
            ...
            obj.setallowromportmodesolver = flag;
        end
        function SetAllowDiscretePortSolver(obj, flag)
            ...
            obj.setallowdiscreteportsolver = flag;
        end
        function SetUseROMPortModeSolverTet(obj, general, fast)
            ...
            obj.AddToHistory(['.SetUseROMPortModeSolverTet "', num2str(general, '%.15g'), '", '...
                                                          '"', num2str(fast, '%.15g'), '"']);
            obj.setuseromportmodesolvertet.general = general;
            obj.setuseromportmodesolvertet.fast = fast;
        end
        function EnableNativeSingleEnded(obj, flag)
            ...
            obj.enablenativesingleended = flag;
        end
        ...
        function SetUseImpLineImpedanceAsReference(obj, flag)
            ...
            obj.setuseimplineimpedanceasreference = flag;
        end
        function SetUseOrientPortWithMask(obj, flag)
            ...
            obj.setuseorientportwithmask = flag;
        end
        function ConsiderPortLossesTet(obj, flag)
            ...
            obj.considerportlossestet = flag;
        end
        function SetStopSweepIfCriterionMet(obj, flag)
            ...
            obj.setstopsweepifcriterionmet = flag;
        end
        function SetSweepThreshold(obj, type, threshold)
            ...
            obj.setsweepthreshold.type = type;
            obj.setsweepthreshold.threshold = threshold;
        end
        function UseSweepThreshold(obj, type, flag)
            ...
            obj.AddToHistory(['.UseSweepThreshold "', num2str(type, '%.15g'), '", '...
                                                 '"', num2str(flag, '%.15g'), '"']);
            obj.usesweepthreshold.type = type;
            obj.usesweepthreshold.flag = flag;
        end
        ...
        function SetMethod(obj, mesh, sweep)
            ...
            obj.AddToHistory(['.SetMethod "', num2str(mesh, '%.15g'), '", '...
                                         '"', num2str(sweep, '%.15g'), '"']);
            obj.setmethod.mesh = mesh;
            obj.setmethod.sweep = sweep;
        end
        ...
        function Stimulation(obj, port, mode)
            ...
            obj.AddToHistory(['.Stimulation "', num2str(port, '%.15g'), '", '...
                                           '"', num2str(mode, '%.15g'), '"']);
            obj.stimulation.port = port;
            obj.stimulation.mode = mode;
        end
        ...
        function SweepMinimumSamples(obj, nSamples)
            ...
            obj.sweepminimumsamples = nSamples;
        end
        ...
        function SweepConsiderSPar(obj, port_out, mode_out, port_in, mode_in)
            ...
            obj.AddToHistory(['.SweepConsiderSPar "', num2str(port_out, '%.15g'), '", '...
                                                 ...
                                                 '"', num2str(port_in, '%.15g'), '", '...
                                                 '"', num2str(mode_in, '%.15g'), '"']);
            obj.sweepconsiderspar.port_out = port_out;
            obj.sweepconsiderspar.mode_out = mode_out;
            obj.sweepconsiderspar.port_in = port_in;
            obj.sweepconsiderspar.mode_in = mode_in;
        end
        function SetNumberOfResultDataSamples(obj, nSamples)
            ...
            obj.setnumberofresultdatasamples = nSamples;
        end
        function SetResultDataSamplingMode(obj, mode)
            ...
            obj.setresultdatasamplingmode = mode;
        end
        ...
        function TDCompatibleMaterials(obj, flag)
            ...
            obj.tdcompatiblematerials = flag;
        end
        ...
        function CalcPowerLossPerComponent(obj, flag)
            ...
            obj.calcpowerlosspercomponent = flag;
        end
        function SetUseGreenSandyFerriteModel(obj, flag)
            ...
            obj.setusegreensandyferritemodel = flag;
        end
        function SetGreenSandyThresholdH(obj, value)
            ...
            obj.setgreensandythresholdh = value;
        end
        ...
        function AddToExcitationList(obj, port, mode)
            ...
            obj.AddToHistory(['.AddToExcitationList "', num2str(port, '%.15g'), '", '...
                                                   '"', num2str(mode, '%.15g'), '"']);
            obj.addtoexcitationlist.port = port;
            obj.addtoexcitationlist.mode = mode;
        end
        ...
        function MaximumNumberOfCPUDevices(obj, MaximumNumberOfCPUDevices)
            ...
            obj.maximumnumberofcpudevices = MaximumNumberOfCPUDevices;
        end
        function SweepWeightEvanescent(obj, dWeight)
            ...
            obj.sweepweightevanescent = dWeight;
        end
        ...
        function UseDistributedComputing(obj, flag)
            ...
            obj.usedistributedcomputing = flag;
        end
        function NetworkComputingStrategy(obj, key)
            ...
            obj.networkcomputingstrategy = key;
        end
        ...
        function UseSensitivityAnalysis(obj, flag)
            ...
            obj.usesensitivityanalysis = flag;
        end
        ...
        function PreconditionerAccuracyIntEq(obj, value)
            ...
            obj.preconditioneraccuracyinteq = value;
        end
        ...
        function SetMRCSSweepProperties(obj, Phi_Start, Phi_End, Num_Phi_Steps, Theta_Start, Theta_End, Num_Theta_Steps, E_inc_Theta, E_inc_Phi)
            ...
            obj.setmrcssweepproperties.Phi_Start = Phi_Start;
            obj.setmrcssweepproperties.Phi_End = Phi_End;
            obj.setmrcssweepproperties.Num_Phi_Steps = Num_Phi_Steps;
            obj.setmrcssweepproperties.Theta_Start = Theta_Start;
            obj.setmrcssweepproperties.Theta_End = Theta_End;
            obj.setmrcssweepproperties.Num_Theta_Steps = Num_Theta_Steps;
            obj.setmrcssweepproperties.E_inc_Theta = E_inc_Theta;
            obj.setmrcssweepproperties.E_inc_Phi = E_inc_Phi;
        end
        ...
        function SetCalcBlockExcitationsInParallel(obj, enable, useblock, maxparallel)
            ...
            obj.setcalcblockexcitationsinparallel.enable = enable;
            obj.setcalcblockexcitationsinparallel.useblock = useblock;
            obj.setcalcblockexcitationsinparallel.maxparallel = maxparallel;
        end
        function SetWrite3DFieldsForFarfieldCalc(obj, flag)
            ...
            obj.setwrite3dfieldsforfarfieldcalc = flag;
        end
        function SetRecordUnitCellScanFarfield(obj, key)
            ...
            obj.setrecordunitcellscanfarfield = key;
        end
        function SetConsiderUnitCellScanFarfieldSymmetry(obj, theta, phi)
            ...
            obj.AddToHistory(['.SetConsiderUnitCellScanFarfieldSymmetry "', num2str(theta, '%.15g'), '", '...
                                                                       '"', num2str(phi, '%.15g'), '"']);
            obj.setconsiderunitcellscanfarfieldsymmetry.theta = theta;
            obj.setconsiderunitcellscanfarfieldsymmetry.phi = phi;
        end
        function SetDisableResultTemplatesDuringUnitCellScanAngleSweep(obj, disable)
            ...
            obj.setdisableresulttemplatesduringunitcellscananglesweep = disable;
        end
        function ExtractUnitCellScanFarfield(obj, frequencies, names, anchor)
            ...
            obj.AddToHistory(['.ExtractUnitCellScanFarfield "', num2str(frequencies, '%.15g'), '", '...
                                                           '"', num2str(names, '%.15g'), '", '...
                                                           '"', num2str(anchor, '%.15g'), '"']);
            obj.extractunitcellscanfarfield.frequencies = frequencies;
            obj.extractunitcellscanfarfield.names = names;
            obj.extractunitcellscanfarfield.anchor = anchor;
        end
        function string = UpdateInterpolationSettings(obj, navigationtreepath)
            ...
            obj.updateinterpolationsettings = navigationtreepath;
        end
        function ExportMORSolution(obj, frequency)
            ...
            obj.exportmorsolution = frequency;
        end
    ...
    properties(SetAccess = protected)
        ...
        meshadaptionhex
        meshadaptiontet
        resetsampleintervals
        usehelmholtzequation
        addsampleinterval
        addinactivesampleinterval
        maxiterations
        limititerations
        modesonly
        setshieldallports
        setportmeshmatches3dmeshtet
        setallowromportmodesolver
        setallowdiscreteportsolver
        setuseromportmodesolvertet
        enablenativesingleended
        usedeembeddedfields
        freqdistadaptmode
        setpreferleanoutput
        setuseimplineimpedanceasreference
        setuseorientportwithmask
        considerportlossestet
        setstopsweepifcriterionmet
        setsweepthreshold
        usesweepthreshold
        type
        storeresultsincache
        ...
        sweepconsiderall
        sweepconsiderspar
        setnumberofresultdatasamples
        setresultdatasamplingmode
        extrudeopenbc
        tdcompatiblematerials
        calcstatbfield
        calcpowerloss
        calcpowerlosspercomponent
        setusegreensandyferritemodel
        ...
        setmrcssweepproperties
        setcalcblockexcitationsinparallel
        setwrite3dfieldsforfarfieldcalc
        setrecordunitcellscanfarfield
        setconsiderunitcellscanfarfieldsymmetry
        setdisableresulttemplatesduringunitcellscananglesweep
        extractunitcellscanfarfield
        updateinterpolationsettings
        exportmorsolution
        interpolationsamples
        newiterativesolver
        usedoubleprecision_ml
    end
end
