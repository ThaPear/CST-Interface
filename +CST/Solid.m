...
classdef Solid < handle
    ...
    methods
        ...
        function ChangeComponent(obj, oldName, newName)
            ...
            obj.AddToHistory(['.ChangeComponent "', num2str(oldName, '%.15g'), '", '...
                                               '"', num2str(newName, '%.15g'), '"']);
            obj.changecomponent.oldName = oldName;
            obj.changecomponent.newName = newName;
        end
        function ChangeMaterial(obj, oldName, newName)
            ...
            obj.AddToHistory(['.ChangeMaterial "', num2str(oldName, '%.15g'), '", '...
                                              '"', num2str(newName, '%.15g'), '"']);
            obj.changematerial.oldName = oldName;
            obj.changematerial.newName = newName;
        end
        function SetUseIndividualColor(obj, SolidName, flag)
            ...
            obj.AddToHistory(['.SetUseIndividualColor "', num2str(SolidName, '%.15g'), '", '...
                                                     '"', num2str(flag, '%.15g'), '"']);
            obj.setuseindividualcolor.SolidName = SolidName;
            obj.setuseindividualcolor.flag = flag;
        end
        function ChangeIndividualColor(obj, SolidName, r, g, b)
            ...
            obj.AddToHistory(['.ChangeIndividualColor "', num2str(SolidName, '%.15g'), '", '...
                                                     ...
                                                     '"', num2str(g, '%.15g'), '", '...
                                                     '"', num2str(b, '%.15g'), '"']);
            obj.changeindividualcolor.SolidName = SolidName;
            obj.changeindividualcolor.r = r;
            obj.changeindividualcolor.g = g;
            obj.changeindividualcolor.b = b;
        end
        ...
        function Add(obj, solid1, solid2)
            ...
            obj.AddToHistory(['.Add "', num2str(solid1, '%.15g'), '", '...
                                   '"', num2str(solid2, '%.15g'), '"']);
            obj.add.solid1 = solid1;
            obj.add.solid2 = solid2;
        end
        function Insert(obj, solid1, solid2)
            ...
            obj.AddToHistory(['.Insert "', num2str(solid1, '%.15g'), '", '...
                                      '"', num2str(solid2, '%.15g'), '"']);
            obj.insert.solid1 = solid1;
            obj.insert.solid2 = solid2;
        end
        function Intersect(obj, solid1, solid2)
            ...
            obj.AddToHistory(['.Intersect "', num2str(solid1, '%.15g'), '", '...
                                         '"', num2str(solid2, '%.15g'), '"']);
            obj.intersect.solid1 = solid1;
            obj.intersect.solid2 = solid2;
        end
        function Subtract(obj, solid1, solid2)
            ...
            obj.AddToHistory(['.Subtract "', num2str(solid1, '%.15g'), '", '...
                                        '"', num2str(solid2, '%.15g'), '"']);
            obj.subtract.solid1 = solid1;
            obj.subtract.solid2 = solid2;
        end
        function MergeMaterialsOfComponent(obj, name)
            ...
            obj.mergematerialsofcomponent = name;
        end
        %% Appearance
        function ShapeVisualizationAccuracy(obj, acc)
            ...
            obj.shapevisualizationaccuracy = acc;
        end
        function ShapeVisualizationOffset(obj, offset)
            ...
            obj.shapevisualizationoffset = offset;
        end
        %% Advanced Modelling
        ...
        function ChamferEdge(obj, depth, angle, boolean, faceID)
            ...
            obj.AddToHistory(['.ChamferEdge "', num2str(depth, '%.15g'), '", '...
                                           ...
                                           '"', num2str(boolean, '%.15g'), '", '...
                                           '"', num2str(faceID, '%.15g'), '"']);
            obj.chamferedge.depth = depth;
            obj.chamferedge.angle = angle;
            obj.chamferedge.boolean = boolean;
            obj.chamferedge.faceID = faceID;
        end
        function SliceShape(obj, sName, componentName)
            ...
            obj.sliceshape.sName = sName;
            obj.sliceshape.componentName = componentName;
        end
        function SplitShape(obj, sName, componentName)
            ...
            obj.AddToHistory(['.SplitShape "', num2str(sName, '%.15g'), '", '...
                                          '"', num2str(componentName, '%.15g'), '"']);
            obj.splitshape.sName = sName;
            obj.splitshape.componentName = componentName;
        end
        function ThickenSheetAdvanced(obj, solid1, key, thickness, clearpicks)
            ...
            obj.thickensheetadvanced.solid1 = solid1;
            obj.thickensheetadvanced.key = key;
            obj.thickensheetadvanced.thickness = thickness;
            obj.thickensheetadvanced.clearpicks = clearpicks;
        end
        function ShellAdvanced(obj, solid1, key, thickness, clearpicks)
            ...
            obj.AddToHistory(['.ShellAdvanced "', num2str(solid1, '%.15g'), '", '...
                                             ...
                                             '"', num2str(thickness, '%.15g'), '", '...
                                             '"', num2str(clearpicks, '%.15g'), '"']);
            obj.shelladvanced.solid1 = solid1;
            obj.shelladvanced.key = key;
            obj.shelladvanced.thickness = thickness;
            obj.shelladvanced.clearpicks = clearpicks;
        end
        function FillupSpaceAdvanced(obj, sName, componentName, materialName)
            ...
            obj.fillupspaceadvanced.sName = sName;
            obj.fillupspaceadvanced.componentName = componentName;
            obj.fillupspaceadvanced.materialName = materialName;
        end
        ...
        function MoveSelectedFace(obj, dx, dy, dz)
            ...
            obj.AddToHistory(['.MoveSelectedFace "', num2str(dx, '%.15g'), '", '...
                                                '"', num2str(dy, '%.15g'), '", '...
                                                '"', num2str(dz, '%.15g'), '"']);
            obj.moveselectedface.dx = dx;
            obj.moveselectedface.dy = dy;
            obj.moveselectedface.dz = dz;
        end
        function MoveSelectedPlanarFace(obj, offset)
            ...
            obj.moveselectedplanarface = offset;
        end
        ...
        function SetMeshStepWidth(obj, solid1, dx, dy, dz)
            ...
            obj.AddToHistory(['.SetMeshStepWidth "', num2str(solid1, '%.15g'), '", '...
                                                ...
                                                '"', num2str(dy, '%.15g'), '", '...
                                                '"', num2str(dz, '%.15g'), '"']);
            obj.setmeshstepwidth.solid1 = solid1;
            obj.setmeshstepwidth.dx = dx;
            obj.setmeshstepwidth.dy = dy;
            obj.setmeshstepwidth.dz = dz;
        end
        function SetMeshExtendwidth(obj, solid1, dx, dy, dz)
            ...
            obj.AddToHistory(['.SetMeshExtendwidth "', num2str(solid1, '%.15g'), '", '...
                                                  ...
                                                  '"', num2str(dy, '%.15g'), '", '...
                                                  '"', num2str(dz, '%.15g'), '"']);
            obj.setmeshextendwidth.solid1 = solid1;
            obj.setmeshextendwidth.dx = dx;
            obj.setmeshextendwidth.dy = dy;
            obj.setmeshextendwidth.dz = dz;
        end
        function SetAutomeshFixpoints(obj, solid1, flag)
            ...
            obj.AddToHistory(['.SetAutomeshFixpoints "', num2str(solid1, '%.15g'), '", '...
                                                    '"', num2str(flag, '%.15g'), '"']);
            obj.setautomeshfixpoints.solid1 = solid1;
            obj.setautomeshfixpoints.flag = flag;
        end
        function SetAutomeshPriority(obj, solid1, priority)
            ...
            obj.setautomeshpriority.solid1 = solid1;
            obj.setautomeshpriority.priority = priority;
        end
        function SetMaterialBasedRefinement(obj, solid1, flag)
            ...
            obj.AddToHistory(['.SetMaterialBasedRefinement "', num2str(solid1, '%.15g'), '", '...
                                                          '"', num2str(flag, '%.15g'), '"']);
            obj.setmaterialbasedrefinement.solid1 = solid1;
            obj.setmaterialbasedrefinement.flag = flag;
        end
        function SetMeshProperties(obj, solid1, type, defaultType)
            ...
            obj.setmeshproperties.solid1 = solid1;
            obj.setmeshproperties.type = type;
            obj.setmeshproperties.defaultType = defaultType;
        end
        function SetUseForSimulation(obj, solid1, flag)
            ...
            obj.AddToHistory(['.SetUseForSimulation "', num2str(solid1, '%.15g'), '", '...
                                                   '"', num2str(flag, '%.15g'), '"']);
            obj.setuseforsimulation.solid1 = solid1;
            obj.setuseforsimulation.flag = flag;
        end
        function SetUseThinSheetMeshForShape(obj, solid1, flag)
            ...
            obj.AddToHistory(['.SetUseThinSheetMeshForShape "', num2str(solid1, '%.15g'), '", '...
                                                           '"', num2str(flag, '%.15g'), '"']);
            obj.setusethinsheetmeshforshape.solid1 = solid1;
            obj.setusethinsheetmeshforshape.flag = flag;
        end
        function SetMeshRefinement(obj, solid1, edgeRefine, edgeRefineFact, volumeRefine, volumeRefineFact)
            ...
            obj.setmeshrefinement.solid1 = solid1;
            obj.setmeshrefinement.edgeRefine = edgeRefine;
            obj.setmeshrefinement.edgeRefineFact = edgeRefineFact;
            obj.setmeshrefinement.volumeRefine = volumeRefine;
            obj.setmeshrefinement.volumeRefineFact = volumeRefineFact;
        end
        function SetSolidLocalMeshProperties(obj, solid1, type, defaultType, priority, flagAutomeshFixpoints, flagMaterialBaseRefinement, dxStepwidth, dyStepwidth, dzStepwidth, dxExtendwidth, dyExtendwidth, dzExtendwidth, edgeRefine, edgeRefineFact, volumeRefine, volumeRefineFact, flagThinSheetMeshForShape, flagUseForSimulation, flagUseForBoundingBox, flagLimitStepWidth)
            ...
            obj.setsolidlocalmeshproperties.solid1 = solid1;
            obj.setsolidlocalmeshproperties.type = type;
            obj.setsolidlocalmeshproperties.defaultType = defaultType;
            obj.setsolidlocalmeshproperties.priority = priority;
            obj.setsolidlocalmeshproperties.flagAutomeshFixpoints = flagAutomeshFixpoints;
            obj.setsolidlocalmeshproperties.flagMaterialBaseRefinement = flagMaterialBaseRefinement;
            obj.setsolidlocalmeshproperties.dxStepwidth = dxStepwidth;
            obj.setsolidlocalmeshproperties.dyStepwidth = dyStepwidth;
            obj.setsolidlocalmeshproperties.dzStepwidth = dzStepwidth;
            obj.setsolidlocalmeshproperties.dxExtendwidth = dxExtendwidth;
            obj.setsolidlocalmeshproperties.dyExtendwidth = dyExtendwidth;
            obj.setsolidlocalmeshproperties.dzExtendwidth = dzExtendwidth;
            obj.setsolidlocalmeshproperties.edgeRefine = edgeRefine;
            obj.setsolidlocalmeshproperties.edgeRefineFact = edgeRefineFact;
            obj.setsolidlocalmeshproperties.volumeRefine = volumeRefine;
            obj.setsolidlocalmeshproperties.volumeRefineFact = volumeRefineFact;
            obj.setsolidlocalmeshproperties.flagThinSheetMeshForShape = flagThinSheetMeshForShape;
            obj.setsolidlocalmeshproperties.flagUseForSimulation = flagUseForSimulation;
            obj.setsolidlocalmeshproperties.flagUseForBoundingBox = flagUseForBoundingBox;
            obj.setsolidlocalmeshproperties.flagLimitStepWidth = flagLimitStepWidth;
        end
        ...
        function SetMeshStepwidthTet(obj, solid1, dmax)
            ...
            obj.AddToHistory(['.SetMeshStepwidthTet "', num2str(solid1, '%.15g'), '", '...
                                                   '"', num2str(dmax, '%.15g'), '"']);
            obj.setmeshstepwidthtet.solid1 = solid1;
            obj.setmeshstepwidthtet.dmax = dmax;
        end
        function SetMeshStepwidthSrf(obj, solid1, dmax)
            ...
            obj.AddToHistory(['.SetMeshStepwidthSrf "', num2str(solid1, '%.15g'), '", '...
                                                   '"', num2str(dmax, '%.15g'), '"']);
            obj.setmeshstepwidthsrf.solid1 = solid1;
            obj.setmeshstepwidthsrf.dmax = dmax;
        end
        %% Healing
        ...
        function ManualShapeHealing(obj, solid1, simplify, stitch, geombuild, simplify_tol, stitch_tol, geombuild_tol)
            ...
            obj.manualshapehealing.solid1 = solid1;
            obj.manualshapehealing.simplify = simplify;
            obj.manualshapehealing.stitch = stitch;
            obj.manualshapehealing.geombuild = geombuild;
        ...
        function CheckSoild(obj, solid1, CheckLevel)
            ...
            obj.checksoild.solid1 = solid1;
            obj.checksoild.CheckLevel = CheckLevel;
        end
        ...
        function ShowBoundingBoxProblems(obj, solid1)
            ...
            obj.showboundingboxproblems = solid1;
        end
        ...
        function ShowMaximumTolerance(obj, solid1)
            ...
            obj.showmaximumtolerance = solid1;
        end
        ...
        function ShowTolerantVertices(obj, solid1)
            ...
            obj.showtolerantvertices = solid1;
        end
        ...
        function ShowEdgeRange(obj, min, max)
            ...
            obj.AddToHistory(['.ShowEdgeRange "', num2str(min, '%.15g'), '", '...
                                             '"', num2str(max, '%.15g'), '"']);
            obj.showedgerange.min = min;
            obj.showedgerange.max = max;
        end
        ...
        function DeleteFacesForSelectedEdge(obj, solid1)
            ...
            obj.deletefacesforselectededge = solid1;
        end
        ...
        function AddLinearCurveFromPoints(obj, solid1)
            ...
            obj.addlinearcurvefrompoints = solid1;
        end
        function AddTangentCurveFromPoints(obj, solid1, key1, key2, flag1, flag2)
            ...
            obj.AddToHistory(['.AddTangentCurveFromPoints "', num2str(solid1, '%.15g'), '", '...
                                                         ...
                                                         '"', num2str(flag1, '%.15g'), '", '...
                                                         '"', num2str(flag2, '%.15g'), '"']);
            obj.addtangentcurvefrompoints.solid1 = solid1;
            obj.addtangentcurvefrompoints.key1 = key1;
            obj.addtangentcurvefrompoints.key2 = key2;
            obj.addtangentcurvefrompoints.flag1 = flag1;
            obj.addtangentcurvefrompoints.flag2 = flag2;
        end
        function LoftSelectedEdges(obj, constraint1, strength1, invert1, constraint2, strength2, invert2)
            ...
            obj.AddToHistory(['.LoftSelectedEdges "', num2str(constraint1, '%.15g'), '", '...
                                                 ...
                                                 '"', num2str(invert2, '%.15g'), '"']);
            obj.loftselectededges.constraint1 = constraint1;
            obj.loftselectededges.strength1 = strength1;
            obj.loftselectededges.invert1 = invert1;
            obj.loftselectededges.constraint2 = constraint2;
            obj.loftselectededges.strength2 = strength2;
            obj.loftselectededges.invert2 = invert2;
        end
        ...
        function SplitSelectedEdgeAtPickedPoint(obj, solid1)
            ...
            obj.splitselectededgeatpickedpoint = solid1;
        end
        function RenameCurve(obj, curve1, curve2)
            ...
            obj.AddToHistory(['.RenameCurve "', num2str(curve1, '%.15g'), '", '...
                                           '"', num2str(curve2, '%.15g'), '"']);
            obj.renamecurve.curve1 = curve1;
            obj.renamecurve.curve2 = curve2;
        end
        ...
        function CreateShapeFromFaces(obj, sName, componentName, materialName)
            ...
            obj.AddToHistory(['.CreateShapeFromFaces "', num2str(sName, '%.15g'), '", '...
                                                    '"', num2str(componentName, '%.15g'), '", '...
                                                    '"', num2str(materialName, '%.15g'), '"']);
            obj.createshapefromfaces.sName = sName;
            obj.createshapefromfaces.componentName = componentName;
            obj.createshapefromfaces.materialName = materialName;
        end
        ...
        function FacettedRepresentationOfShape(obj, solid1, surftol, normaltol, maxEdlen, minPtDist)
            ...
            obj.facettedrepresentationofshape.solid1 = solid1;
            obj.facettedrepresentationofshape.surftol = surftol;
            obj.facettedrepresentationofshape.normaltol = normaltol;
            obj.facettedrepresentationofshape.maxEdlen = maxEdlen;
            obj.facettedrepresentationofshape.minPtDist = minPtDist;
        end
        function SimplifyFigureOfRotation(obj, solid1, value, key)
            ...
            obj.AddToHistory(['.SimplifyFigureOfRotation "', num2str(solid1, '%.15g'), '", '...
                                                        '"', num2str(value, '%.15g'), '", '...
                                                        '"', num2str(key, '%.15g'), '"']);
            obj.simplifyfigureofrotation.solid1 = solid1;
            obj.simplifyfigureofrotation.value = value;
            obj.simplifyfigureofrotation.key = key;
        end
        %% Queries
        ...
        function name = GetNameOfShapeFromIndex(obj, index)
            ...
            obj.getnameofshapefromindex = index;
        end
        function name = GetMaterialNameForShape(obj, solid1)
            ...
            obj.getmaterialnameforshape = solid1;
        end
        function bool = IsPointInsideShape(obj, x, y, z, solid1)
            ...
            obj.ispointinsideshape.x = x;
            obj.ispointinsideshape.y = y;
            obj.ispointinsideshape.z = z;
            obj.ispointinsideshape.solid1 = solid1;
        end
        function bool = IsPointOnAnyEdgeOfShape(obj, x, y, z, solid1)
            ...
            obj.ispointonanyedgeofshape.x = x;
            obj.ispointonanyedgeofshape.y = y;
            obj.ispointonanyedgeofshape.z = z;
            obj.ispointonanyedgeofshape.solid1 = solid1;
        end
        function double = GetVolume(obj, solid1)
            % Returns the volume of the given shape.
            double = obj.hSolid.invoke('GetVolume', solid1);
            obj.getvolume = solid1;
        end
        ...
        function int = GetAnyFaceIdFromSolid(obj, solid1)
            ...
            obj.getanyfaceidfromsolid = solid1;
        end
    ...
    properties(SetAccess = protected)
        ...
        intersect
        subtract
        mergematerialsofcomponent
        shapevisualizationaccuracy
        shapevisualizationoffset
        attachactivewcs
        blendedge
        chamferedge
        sliceshape
        splitshape
        thickensheetadvanced
        shelladvanced
        fillupspaceadvanced
        moveselectedface
        moveselectedplanarface
        offsetselectedface
        selectedfaceradius
        setmeshstepwidth
        setmeshextendwidth
        setautomeshfixpoints
        setautomeshpriority
        setmaterialbasedrefinement
        setmeshproperties
        setuseforsimulation
        setusethinsheetmeshforshape
        setmeshrefinement
        setsolidlocalmeshproperties
        setmeshstepwidthtet
        setmeshstepwidthsrf
        healshapeadvanced
        healselfintersectingshape
        healfacesofshape
        manualshapehealing
        makebadelementstolerant
        cleanshape
        checksoild
        pickdanglingedges
        pickjunctionedges
        showbadedges
        showbadvertices
        showboundingboxproblems
        showdanglingedges
        showmaximumtolerance
        showsplineedges
        showsplinefaces
        showtolerantedges
        showtolerantvertices
        showedgerange
        deletefacesforselectededge
        deletezerofaces
        reverseshape
        addlinearcurvefrompoints
        addtangentcurvefrompoints
        loftselectededges
        splitselectededgeatpickedpoint
        renamecurve
        deletecurve
        createshapefromfaces
        facettedrepresentationofshape
        simplifyfigureofrotation
        getnameofshapefromindex
        getmaterialnameforshape
        ispointinsideshape
