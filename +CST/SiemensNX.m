...
classdef SiemensNX < handle
    %% CST Interface specific functions.
    methods(Access = ?CST.Project)
        % Only CST.Project can create a CST.SiemensNX object.
        function obj = SiemensNX(project, hProject)
            obj.project = project;
            obj.hSiemensNX = hProject.invoke('SiemensNX');
            obj.history = [];
        end
    end
    methods
    ...
    methods
        ...
        function Read(obj)
            ...
            % Prepend With SiemensNX and append End With
            obj.history = [ 'With SiemensNX', newline, ...
                                obj.history, ...
                            'End With'];
            obj.project.AddToHistory(['import SiemensNX: ', obj.filename], obj.history);
            obj.history = [];
        end
    end
...
% siemensnx = project.SiemensNX();
%     siemensnx.Reset
%     siemensnx.FileName('.\example.prt');
%     siemensnx.ScaleToUnit(1)
%     siemensnx.Id(1)
%     siemensnx.Healing(1)
%     siemensnx.ImportAttributes(1)
%     siemensnx.Curves(1)
%     siemensnx.ImportCurveAttributes(1)
%     siemensnx.Read
