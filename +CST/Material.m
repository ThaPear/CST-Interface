...
classdef Material < handle
    ...
    methods
        ...
        function Delete(obj, name)
            ...
            obj.project.AddToHistory(['Material.Delete "', num2str(name, '%.15g'), '"']);
        end
        function Rename(obj, sOldName, sNewName)
            % Renames the object specified by sOldName to sNewName.
            obj.project.AddToHistory(['Material.Rename "', num2str(sOldName, '%.15g'), '", '...
        ...
        function Rho(obj, dValue)
            ...
            % Sets the material density value of the material in kg/mï¿½, i.e. used for SAR calculations.
        ...
        function LossyMetalSIRoughness(obj, roughness)
            ...
            % The roughness effect is predicted from this only one single parameter using the Gradient Model. According to this physical and Maxwellï¿½s equation based formulation an equivalent frequency dependent impedance is computed accounting for the increased total loss due to surface roughness. See the Gradient Model description in the Material Overview (HF) - Lossy metal section for more information.
